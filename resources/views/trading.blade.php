...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title" class="page-title-parallax" style="background-image: url('images/parallax/9.jpg'); padding: 120px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
			...
			<div class="container clearfix">
				<h1 data-animate="fadeInUp">Oil & Tire</h1>
					...
					<div class="container">
						...
						<div class="col-md-4 mb-5">
							<div class="card course-card hover-effect noborder">
								<a href="{{route('dtrade',$item->id )}}"><img height="300px" class="card-img-top" src="{{asset('img/trading/'.$item->gambar)}}" alt="Card image cap"></a>
								<div class="card-body">
								<h4 class="card-title t700 mb-2"><a href="{{route('dtrade',$item->id )}}">@if(app()->getLocale()=='id') {{$item->nama}} @else {{$item->name}} @endif</a></h4>
								<p class="mb-2 card-title-sub uppercase t400 ls1"><a href="{{route('dtrade',$item->id )}}" class="text-black-50">{{$item->type}}</a></p>
								</div>									
							</div>
						</div>
						@endforeach
