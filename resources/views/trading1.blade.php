...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title" class="page-title-parallax" style="background-image: url('images/parallax/9.jpg'); padding: 120px 0;" data-bottom-top="background-position:0px 300px;" data-top-bottom="background-position:0px -300px;">
			...
			<div class="container clearfix">
				<h1 data-animate="fadeInUp">Trading</h1>
				<span data-animate="fadeInUp" data-delay="300">Oil & Trading berlokasi di Makassar, Kendari dan Manado</span>
				<span data-animate="fadeInUp" data-delay="400">Kumala Group</span>
			</div>
        		...
        		<!-- Wave Shape Divider
					...
					<div class="container">
                        ...
                        <div id="posts" class="post-grid grid-container grid-2 clearfix" data-layout="fitRows">
                            ...
                            <div class="entry clearfix center">
                                <div class="entry-title">
                                    <h2><a href="{{route('trading')}}">OIL : PT. KUMALA PUTRA PRIMA</a></h2>
                                </div>
                                <div class="entry-image">
                                    <a href="{{route('trading')}}"><img class="image_fade" src="{{asset('images/trading/oil.png')}}" alt="Standard Post with Image"></a>
                                </div>
                            </div>

                            <div class="entry clearfix center">
                                <div class="entry-title">
                                    <h2><a href="{{route('trading')}}">TIRE : PT. KUMALA SUKSES ABADI</a></h2>
                                </div>
                                <div class="entry-image">
                                    <a href="{{route('trading')}}"><img class="image_fade" src="{{asset('images/trading/tire.png')}}" alt="Standard Post with Image"></a>
                                </div>
                            </div>
                        </div>
