...
<section id="content">
	...
	<div class="content-wrap">
		...
		<div class="heading-block notopmargin notopborder center">
			<h3 data-animate="fadeInDown">@if(app()->getLocale()=='id')
				Tentang Kami @else About Us @endif </h3>
		...
		<div class="section notopmargin notopborder" id="unitbisnis">
			...
			<div class="heading-block center">
				<h3 data-animate="fadeInDown">@lang('navbar.unit') </h3>
				<!-- <span>We have worked on some Awesome Projects that are worth boasting of.</span> -->
			</div>
				...
				<div class="col_one_fourth nobottommargin">
					<div class="feature-box media-box" data-animate="fadeInDownBig">
						<div class="flip">
							...
							<div class="back">
								<h2><a style="text-decoration:none;color: #fff !important;" href="{{route('property')}}">Properties</a></h2>
								<p>Good tools make application development quicker and easier to maintain than if you did everything by hand...<a href="{{route('property')}}">Read more</a></p>
							</div>
						</div>
					</div>
				</div>
				<div class="col_one_fourth nobottommargin">
					<div class="feature-box media-box" data-animate="fadeInDownBig">
						<div class="flip">
							...
							<div class="back">
							<h2><a style="text-decoration:none;color: #fff !important;" href="{{route('trade')}}">Trading</a></h2>
								<p>Good tools make application development quicker and easier to maintain than if you did everything by hand. <a href="{{route('trade')}}">Readmore.</a></p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="col_one_fourth nobottommargin col_last">
					<div class="feature-box media-box" data-animate="fadeInDownBig">
						<div class="flip">
							...
							<div class="back">
								<h2><a style="text-decoration:none;color: #fff !important;" href="{{route('mining')}}">Mining</a></h2>
								<p>Good tools make application development quicker and easier to maintain than if you did everything by hand. <a href="{{route('mining')}}">Read more</a></p>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="bottommargin-sm">
			...
			<div class="container clearfix">
				<div class="heading-block center">
					<h3 data-animate="fadeInDown">@lang('navbar.news') & Promo</h3>
				</div>
			</div>
				...
				<div class="col_one_fourth nobottommargin">
					<div class="ipost clearfix" data-animate="fadeIn">
						...
						<div class="entry-title">
							...
							@else
							<h3><a href="{{route('single', $data->id)}}">{{$data->heading}}</a></h3>
							@endif
						</div>
						...
						<div class="entry-content">
							...
							@else
							<p>{{substr($data->desc,0, 60)}}...<a href="{{route('single', $data->id)}}">More Info. </a></p>
							@endif
						</div>
					</div>
				</div>
			...
			<div class="row topmargin center">
				<div class="col-12 topmargin">
								...
								@else
								<a href="{{route('berita')}}" class="button button-rounded button-reveal button-small button-red tright">More!</a>
								@endif
				</div>
			</div>
		...
		<div class="section topmargin-lg">
			...
			<div class="container clearfix">
				...
				<div class="col_three_fifth">
					...
					<div class="heading-block">
						...
						@else
						<h3 data-animate="fadeInDown">Join <span>Us</span>!</h3>
						@endif
			...
			<div class="heading-block center">
				...
				@else
				<h3 data-animate="fadeInDown">Get <span>News</span>later!</h3>
				@endif
			</div>
