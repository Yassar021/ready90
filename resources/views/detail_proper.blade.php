...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title">
				...
				<div class="container clearfix">
				<h1>@if(app()->getLocale()=='id') {{$data->nama}} @else {{$data->name}} @endif</h1>
				...
				<div class="content-wrap">
					...
					<div class="container clearfix	bottommargin">
						...
						<div class="col_two_third portfolio-single-image bottommargin">
							<img src="{{asset('img/property/'.$data->gambar)}}" width="500" height="300" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></img>
						...
						<p><b>@lang('navbar.alm'): </b>{{$data->alamat}}</p>
						<p><b>@lang('navbar.telp'): </b> {{$data->telp}}</p>
